...
export default function Footer() {
  return (
    ...
    <section className="container-fluid py-4" style={{
      backgroundColor: "#210057",
    }}>
      ...
      <div className="container-fluid my-5 py-2 justify-content-around">
        <div className="row g-5">
          ...
          <div className="col-12 col-md-5 col-lg-4 text-center text-md-start">
            ...
            <p className="ms-1 mt-1 mb-0 text--grey">Learn and crack your first job in Software Company with Quedemy</p>
          </div>
          ...
          <div className="col-12 col-md-7 col-lg-5 text-center">
            <div className="py-5 px-3" style={{
              ...
              <p className="text--grey" style={{ maxWidth: "350px", margin: "auto",fontWeight:"500" }}>
          ...
          <div className="col-12 col-md-3 col-lg-3 text-center text-md-start">
            <h4 style={{ color: "#dcdcdc" }}>Follow us on</h4>
            <ul className="d-inline-flex ps-0 justify-content-center justify-content-md-start">
              <li>
                <a className=" mx-1" href="https://www.linkedin.com/company/quedemy-learning">
